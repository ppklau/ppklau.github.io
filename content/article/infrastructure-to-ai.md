...
Twenty years ago, I started my career as a network engineer, configuring routers and troubleshooting protocols. Today, I'm leading firmwide AI strategy at a global financial institution. The journey from infrastructure to artificial intelligence might seem discontinuous, but the thread connecting them is stronger than it appears.

## The Foundation: Building Reliable Systems

My early years were spent in the trenches—literally underground data centers at times—ensuring that critical systems stayed operational. At companies like JP Morgan Chase and Morgan Stanley, I learned that in financial services, downtime isn't just inconvenient: it's measured in millions of dollars per minute and regulatory scrutiny.
...
- Instrument systems to measure reality against expectations
- Automate responses where possible, escalate intelligently when not
- Continuously improve through retrospectives and data-driven insights

I was essentially applying SRE principles to cybersecurity before I knew that's what I was doing.

## The Transition: AI as Infrastructure
...
### **Risk-First Thinking**
Before deploying any AI system, we assess: What could go wrong? What are the failure modes? How do we detect and respond to them? This is exactly how I approached network and security infrastructure.

### **Governance as Code**
Just as we codified security policies and infrastructure as code, we now codify AI governance: model evaluation criteria, deployment gates, monitoring thresholds, incident response procedures. If it's not automated and measurable, it won't scale.

### **Obsession with Observability**
You can't manage what you can't measure. AI systems need comprehensive instrumentation: model performance metrics, data quality checks, drift detection, fairness evaluations, usage patterns. I build AI monitoring the same way I built security monitoring—with the assumption that we'll need to explain every decision to an auditor.

### **Operationalization Mindset**
The difference between a proof-of-concept and a production system is immense. I've seen too many brilliant demos fail in production because they lacked operational rigor. When evaluating AI use cases, I immediately think about: deployment architecture, scaling constraints, monitoring requirements, incident response, regulatory compliance.
...
**The fundamentals transcend specific technologies.** Systems thinking, risk management, operational discipline—these skills transfer across any domain.
...
*What principles from your early career still guide your work today? I'd be interested to hear your stories.*
